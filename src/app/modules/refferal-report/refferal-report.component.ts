...
@Component({
  selector: 'app-refferal-report',
  templateUrl: './refferal-report.component.html',
  styleUrls: ['./refferal-report.component.css']
})
export class RefferalReportComponent implements OnInit {
  ...
  getProviders() {
    ...
    this.httpClient.getDHIS(`25/analytics.json?dimension=ou:LEVEL-4;${this.orgunit.value}&dimension=pe:2014&displayProperty=NAME&skipData=true`)
      .subscribe((analytics: any) => {
        ...
        this.httpClient.postOpenSRP('report/get-intra-facility-providers-referrals-summary', payload)
          .subscribe(( data: any[]) => {
            console.log('data');
